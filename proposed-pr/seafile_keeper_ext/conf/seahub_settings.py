# KEEPER Self-Service Email Migration
# 
...
# - (Future) optional KEEPER_MIGRATION_* settings for configuration (see integration notes for the key names)
#
# Standard KEEPER email settings (DEFAULT_FROM_EMAIL etc.) are used if present.
