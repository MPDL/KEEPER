...
# define var only if prop available
if '__EMAIL_HOST_USER__'[1:] != '_EMAIL_HOST_USER__':
    EMAIL_HOST_USER = '__EMAIL_HOST_USER__'    # username and domain
if '__EMAIL_HOST_PASSWORD__'[1:] != '_EMAIL_HOST_PASSWORD__':
...
HPSS_ENABLED = '__HPSS_ENABLED__'.lower() == 'true'
if HPSS_ENABLED:
