  ...
  return {
    ...
    getUrl: function(options) {
      ...
      switch (options.name) {
        // File Operations
        case "list_lib_dir":
          return siteRoot + "ajax/lib/" + options.repo_id + "/dir/";
        case "del_dir":
          return siteRoot + "api/v2.1/repos/" + options.repo_id + "/dir/";
        case "del_file":
          return siteRoot + "api/v2.1/repos/" + options.repo_id + "/file/";
        case "get_file_info":
          return siteRoot + "api/v2.1/repos/" + options.repo_id + "/file/";
        case "download_dir_zip_url":
          return fileServerRoot + "zip/" + options.zip_token;
        case "zip_task":
          return siteRoot + "api/v2.1/repos/" + options.repo_id + "/zip-task/";
        case "query_zip_progress":
          return siteRoot + "api/v2.1/query-zip-progress/";
        case "cancel_zip_task":
          return siteRoot + "api/v2.1/cancel-zip-task/";
        case "copy_move_task":
          return siteRoot + "api/v2.1/copy-move-task/";
        case "query_copy_move_progress":
          return siteRoot + "api/v2.1/query-copy-move-progress/";
        case "rename_dir":
          return siteRoot + "api/v2.1/repos/" + options.repo_id + "/dir/";
        case "rename_file":
          return siteRoot + "api/v2.1/repos/" + options.repo_id + "/file/";
        ...
        case "new_file":
          return siteRoot + "api/v2.1/repos/" + options.repo_id + "/file/";
        case "del_dirents":
          return siteRoot + "ajax/repo/" + options.repo_id + "/dirents/delete/";
        case "mv_dirents":
          return siteRoot + "ajax/repo/" + options.repo_id + "/dirents/move/";
        case "cp_dirents":
          return siteRoot + "ajax/repo/" + options.repo_id + "/dirents/copy/";
        case "get_dirents":
          return siteRoot + "ajax/repo/" + options.repo_id + "/dirents/";

        case "dir-details":
          return (
            siteRoot + "api/v2.1/repos/" + options.repo_id + "/dir/detail/"
          );
        case "tags":
          return siteRoot + "api/v2.1/repos/" + options.repo_id + "/tags/";
        case "file-comments":
          return siteRoot + "api2/repos/" + options.repo_id + "/file/comments/";

        // Repos
        case "repos":
          return siteRoot + "api2/repos/";
        case "deleted_repos":
          return siteRoot + "api/v2.1/deleted-repos/";
        case "pub_repos":
          return siteRoot + "api2/repos/public/";
        case "unenc_rw_repos":
          return siteRoot + "ajax/unenc-rw-repos/";
        case "api_v2.1_repo_set_password":
          return (
            siteRoot + "api/v2.1/repos/" + options.repo_id + "/set-password/"
          );
        case "get_history_changes":
          return (
            siteRoot + "ajax/repo/" + options.repo_id + "/history/changes/"
          );
        case "beshared_repo":
          return siteRoot + "api2/beshared-repos/" + options.repo_id + "/";
        case "dir_shared_items":
          return (
            siteRoot + "api2/repos/" + options.repo_id + "/dir/shared_items/"
          );
        case "shared_repos":
          return siteRoot + "api2/shared-repos/" + options.repo_id + "/";
        case "repo":
          return siteRoot + "api2/repos/" + options.repo_id + "/";
        case "repo_v2.1":
          return siteRoot + "api/v2.1/repos/" + options.repo_id + "/";
        case "repo_owner":
          return siteRoot + "api2/repos/" + options.repo_id + "/owner/";
        case "repo_history_limit":
          return siteRoot + "api2/repos/" + options.repo_id + "/history-limit/";
        ...
        case "repo_shared_upload_links":
          return (
            siteRoot + "api2/repos/" + options.repo_id + "/upload-shared-links/"
          );
        ...
        case "repo_user_folder_perm":
          return (
            siteRoot + "api2/repos/" + options.repo_id + "/user-folder-perm/"
          );
        case "repo_group_folder_perm":
          return (
            siteRoot + "api2/repos/" + options.repo_id + "/group-folder-perm/"
          );
        case "repo_upload_link":
          return siteRoot + "api2/repos/" + options.repo_id + "/upload-link/";
        case "repo_update_link":
          return siteRoot + "api2/repos/" + options.repo_id + "/update-link/";
        ...
        case "repo_labels":
          return siteRoot + "api/v2.1/revision-tags/tagged-items/";
        case "user_repo_labels":
          return siteRoot + "api/v2.1/revision-tags/tag-names/";

        case "group-owned-library-user-folder-permission":
          return (
            siteRoot +
        ...
        case "group-owned-library-group-folder-permission":
          return (
            siteRoot +
            "api/v2.1/group-owned-libraries/" +
            options.repo_id +
        ...
        case "share_admin_repos":
          return siteRoot + "api/v2.1/shared-repos/";
        case "share_admin_repo":
          return siteRoot + "api/v2.1/shared-repos/" + options.repo_id + "/";
        case "share_admin_folders":
          return siteRoot + "api/v2.1/shared-folders/";
        case "share_admin_share_links":
          return siteRoot + "api/v2.1/share-links/";
        case "share_admin_share_link":
          return siteRoot + "api/v2.1/share-links/" + options.token + "/";
        case "share_admin_upload_links":
          return siteRoot + "api/v2.1/upload-links/";
        case "share_admin_upload_link":
          return siteRoot + "api/v2.1/upload-links/" + options.token + "/";

        // Links
        case "send_shared_download_link":
          return siteRoot + "share/link/send/";
        case "send_shared_upload_link":
          return siteRoot + "share/upload_link/send/";
        case "smart_link":
          return siteRoot + "api/v2.1/smart-link/";

        // Group
        case "groups":
          return siteRoot + "api/v2.1/groups/";
        case "all_groups":
          return siteRoot + "api/v2.1/all-groups/";
        case "shareable_groups":
          return siteRoot + "api/v2.1/shareable-groups/";
        case "search_group":
          return siteRoot + "api/v2.1/search-group/";
        case "group":
          return siteRoot + "api/v2.1/groups/" + options.group_id + "/";
        case "group_members":
          return siteRoot + "api/v2.1/groups/" + options.group_id + "/members/";
        case "group_member":
          return (
            siteRoot +
            "api/v2.1/groups/" +
        ...
        case "group_member_bulk":
          return (
            siteRoot + "api/v2.1/groups/" + options.group_id + "/members/bulk/"
          );
        case "group_import_members":
          return (
            siteRoot + "ajax/group/" + options.group_id + "/members/import/"
          );
        case "group_repos":
          return siteRoot + "api2/groups/" + options.group_id + "/repos/";
        case "group_owned_repos":
          return (
            siteRoot +
            "api/v2.1/groups/" +
            options.group_id +
        ...
        case "group_owned_repo_user_share":
          return (
            siteRoot +
            "api/v2.1/group-owned-libraries/" +
            options.repo_id +
        ...
        case "group_owned_repo_group_share":
          return (
            siteRoot +
            "api/v2.1/group-owned-libraries/" +
            options.repo_id +
        ...
        case "address_book_sub_groups":
          return (
            siteRoot +
            "api/v2.1/address-book/groups/" +
            options.group_id +
            "/sub-groups/"
          );
        case "address_book_group_search_members":
          return (
            siteRoot +
            "api/v2.1/address-book/groups/" +
            options.group_id +
        ...
        case "group_discussions":
          return siteRoot + "api2/groups/" + options.group_id + "/discussions/";
        ...
        case "thumbnail_create":
          return siteRoot + "thumbnail/" + options.repo_id + "/create/";
        case "thumbnail_get":
          return (
            siteRoot +
            "thumbnail/" +
        ...
        // Misc
        case "view_raw_file":
          return siteRoot + "repo/" + options.repo_id + "/raw" + options.path;

        case "get_popup_notices":
          return siteRoot + "ajax/get_popup_notices/";
        case "notifications":
          return siteRoot + "api/v2.1/notifications/";
        case "notification":
          return siteRoot + "api/v2.1/notification/";
        case "user_enabled_modules":
          return siteRoot + "api/v2.1/user-enabled-modules/";

        case "starred_files":
          return siteRoot + "api2/starredfiles/";
        case "events":
          return siteRoot + "api2/events/";
        case "devices":
          return siteRoot + "api2/devices/";
        case "invitations":
          return siteRoot + "api/v2.1/invitations/";
        case "invitations_batch":
          return siteRoot + "api/v2.1/invitations/batch/";
        case "invitation":
          return siteRoot + "api/v2.1/invitations/" + options.token + "/";
        case "search_user":
          return siteRoot + "api2/search-user/";
        case "user_profile":
          return siteRoot + "profile/" + options.username + "/";
        case "space_and_traffic":
          return siteRoot + "ajax/space_and_traffic/";

        // sysadmin
        case "sysinfo":
          return siteRoot + "api/v2.1/admin/sysinfo/";
        case "admin-devices":
          return siteRoot + "api/v2.1/admin/devices/";
        case "admin-device-errors":
          return siteRoot + "api/v2.1/admin/device-errors/";
        case "admin-device-trusted-ip":
          return siteRoot + "api/v2.1/admin/device-trusted-ip/";
        case "admin-libraries":
          return siteRoot + "api/v2.1/admin/libraries/";
        case "admin-library":
          return siteRoot + "api/v2.1/admin/libraries/" + options.repo_id + "/";
        case "admin-library-history-limit":
          return (
            siteRoot +
        ...
        case "admin-groups":
          return siteRoot + "api/v2.1/admin/groups/";
        case "admin-group":
          return siteRoot + "api/v2.1/admin/groups/" + options.group_id + "/";
        ...
        case "admin-group-owned-libraries":
          return (
            siteRoot +
            "api/v2.1/admin/groups/" +
            options.group_id +
        ...
        case "admin-group-owned-library":
          return (
            siteRoot +
            "api/v2.1/admin/groups/" +
            options.group_id +
        ...
        case "admin-group-members":
          return (
            siteRoot + "api/v2.1/admin/groups/" + options.group_id + "/members/"
          );
        ...
        case "admin-system-library":
          return siteRoot + "api/v2.1/admin/system-library/";
        case "admin-system-library-upload-link":
          return siteRoot + "api/v2.1/admin/system-library/upload-link/";
        case "admin-trash-libraries":
          return siteRoot + "api/v2.1/admin/trash-libraries/";
        case "admin-trash-library":
          return (
            siteRoot + "api/v2.1/admin/trash-libraries/" + options.repo_id + "/"
          );
        case "admin_shares":
          return siteRoot + "api/v2.1/admin/shares/";
        case "sys_group_admin_export_excel":
          return siteRoot + "sys/groupadmin/export-excel/";
        case "admin-operation-logs":
          return siteRoot + "api/v2.1/admin/admin-logs/";
        case "admin-login-logs":
          return siteRoot + "api/v2.1/admin/admin-login-logs/";

        case "admin-address-book-groups":
          return siteRoot + "api/v2.1/admin/address-book/groups/";
        case "admin-address-book-group":
          return (
            siteRoot +
        ...
        // org admin
        case "org-admin-address-book-groups":
          return (
            siteRoot +
            "api/v2.1/org/" +
            options.org_id +
        ...
        case "org-admin-address-book-group":
          return (
            siteRoot +
            "api/v2.1/org/" +
            options.org_id +
        ...
        case "org-admin-group-libraries":
          return (
            siteRoot +
            "api/v2.1/org/" +
            options.org_id +
        ...
        case "org-admin-group-owned-libraries":
          return (
            siteRoot +
            "api/v2.1/org/" +
            options.org_id +
        ...
        case "org-admin-group-owned-library":
          return (
            siteRoot +
            "api/v2.1/org/" +
            options.org_id +
        ...
        case "license":
          return siteRoot + "api/v2.1/admin/license/";
      }
    },
    ...
    getFileIconUrl: function(filename, size) {
      ...
      if (_.has(this.FILEEXT_ICON_MAP, file_ext)) {
        return (
          ...
          size +
          "/" +
          this.FILEEXT_ICON_MAP[file_ext]
        );
      } else {
        return (
          app.config.mediaUrl +
    ...
    showConfirmWithExtraOption: function(
      title,
      content,
      extraOption,
      yesCallback
      ...
      var confirm_with_extra_option_template = _.template(
        $("#confirm-dialog-with-extra-option-tmpl").html()
      );
      ...
      $yesBtn.on("click", function() {
        var extraOptionChecked =
          $("#confirm-extra-option:checked").val() === "on";
    ...
    feedback: function(con, type, time) {
      ...
      setTimeout(function() {
        $el.css({ top: show_pos_top });
      }, 10);

      setTimeout(function() {
        $el.css({ top: hide_pos_top });
      }, time);
    },
    ...
    prepareAjaxErrorMsg: function(xhr) {
      ...
      if (xhr.responseText) {
        ...
        error_msg = this.HTMLescape(
          parsed_resp.error || parsed_resp.error_msg || parsed_resp.detail
        );
      } else {
    ...
    prepareCollectionFetchErrorMsg: function(collection, response, opts) {
      ...
      if (response.responseText) {
        if (response["status"] == 401) {
          ...
          err_msg = this.HTMLescape(
            JSON.parse(response.responseText).error_msg
          );
        }
      } else {
    ...
    prepareCSRFToken: function(xhr, settings) {
      ...
      if (!(/^http:.*/.test(settings.url) || /^https:.*/.test(settings.url))) {
        ...
        xhr.setRequestHeader(
          "X-CSRFToken",
          getCookie(app.config.csrfCookieName)
        );
      }
    },
    ...
    initLocale: function() {
      ...
      if (app.pageOptions.language_code == "en") {
        ...
        app.pageOptions.language_code == "es-ar" ||
        app.pageOptions.language_code == "es-mx"
      ) {
        language_code = "es";
      } else {
    ...
    closeTopNoticeBar: function() {
      ...
      if (navigator.cookieEnabled) {
        ...
        new_info_id +=
          "; expires=" + date.toGMTString() + "; path=" + app.config.siteRoot;
        for (var i = 0, len = cookies.length; i < len; i++) {
          if (cookies[i].split("=")[0] == "info_id") {
            info_id_exist = true;
            document.cookie =
              "info_id=" + cookies[i].split("=")[1] + new_info_id;
            break;
          }
        }
        if (!info_id_exist) {
        ...
        ajax: {
          ...
          results: function(data) {
            ...
            for (var i = 0, len = users.length; i < len; i++) {
              user_list.push({
                // 'id' & 'text' are required by the plugin
                id: users[i].email,
        ...
        formatResult: function(item) {
          if (item.avatar_url) {
            return (
              '<img src="' +
              item.avatar_url +
              '" width="32" height="32" class="avatar"><span class="text ellipsis">' +
    ...
    compareTwoWord: function(a_name, b_name) {
      ...
      if (19968 < a_uni && a_uni < 40869 && (19968 < b_uni && b_uni < 40869)) {
        ...
        19968 < a_uni &&
        a_uni < 40869 &&
        !(19968 < b_uni && b_uni < 40869)
      ) {
        // a is chinese and b is english
        return 1;
      } else if (
        !(19968 < a_uni && a_uni < 40869) &&
        (19968 < b_uni && b_uni < 40869)
      ) {
    ...
    zipDownload: function(repo_id, parent_dir, dirents) {
      ...
      var queryZipProgress = function() {
        $.ajax({
          url:
            _this.getUrl({ name: "query_zip_progress" }) +
            "?token=" +
            zip_token,
          dataType: "json",
          cache: false,
          success: function(data) {
            var progress =
              data.total == 0
                ? "100%"
                : ((data.zipped / data.total) * 100).toFixed(0) + "%";
