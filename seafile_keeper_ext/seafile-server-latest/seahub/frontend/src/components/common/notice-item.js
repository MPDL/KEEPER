...
class NoticeItem extends React.Component {
  ...
  generatorNoticeInfo () {
    ...
    if (noticeType === BLOXBERG_MSG) {
      let avatar_url = '/media/custom/KeeperAvatar.png';
      detail = JSON.parse(detail);
      let notice = 'Your data was successfully certified. Check your transaction on Bloxberg. <a href=# ' +
          'onClick=\"window.open(https://blockexplorer.bloxberg.org/tx/' +  detail.transaction_id + '/internal_transactions);return false;\">' +
          'View transaction</a>.';
      return {avatar_url, notice};
    }
