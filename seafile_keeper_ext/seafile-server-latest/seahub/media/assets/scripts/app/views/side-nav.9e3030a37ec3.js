define([
    ...
    var sideNavView = Backbone.View.extend({
        ...
        initialize: function() {
            ...
            this.landing_pages_expanded = false;
            ...
            this.data = {
                ...
                'show_landing_page_list': this.landing_pages_expanded,
                'groups': app.pageOptions.groups,
                'landing_pages': app.pageOptions.landing_pages,
        ...
        events: {
            ...
            'click #keeper-landing-page-nav a:first': 'toggleLandingPageList',
        ...
        toggleLandingPageList: function() {
            var $icon = $('#keeper-landing-page-nav .toggle-icon');

            $icon.toggleClass('icon-caret-left icon-caret-down');
            $('#keeper-landing-page-nav .keeper-landing-page-list').slideToggle();

            if ($icon.hasClass('icon-caret-down')) {
                Cookie.set('landing_pages_expanded', 'true');
                this.data.landing_pages_expanded = true;
            } else {
                Cookie.set('landing_pages_expanded', 'false');
                this.data.landing_pages_expanded = false;
            }
            return false;
        },
