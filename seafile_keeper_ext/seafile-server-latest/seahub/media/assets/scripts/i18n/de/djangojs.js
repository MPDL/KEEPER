...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Apply": "Anwenden",
    "Archive": "Archivieren",
    "Archive Library": "Bibliothek archivieren",
    "Archive {library_name}": "Archivierung von {library_name}",
    "Archives": "Archiv",
    ...
    "Assign DOI": "DOI zuweisen",
    "Assign DOI to current state": "DOI der aktuellen Version zuweisen",
    "Assign DOI to {library_name}": "DOI zu {library_name} zuweisen",
    "At server": "Server",
    "Audio": "Audio",
    ...
    "By archiving this library, the current state of everything contained within it will be archived on a dedicated archiving system. For more information, please follow the link: {archive_info_link} This library can be archived {quota} more times.": "Durch die Archivierung der Bibliothek wird die aktuelle Version der ausgew\u00e4hlten Bibliothek (Schnappschuss) und deren Inhalt in ein dediziertes Archivierungssystem kopiert. F\u00fcr mehr Informationen folgen Sie bitte dem nachfolgenden Link: {archive_info_link} Diese Bibliothek kann noch {quota} Mal archiviert werden.",
    ...
    "Cannot archive, since the library is too large.": "Archivierung nicht m\u00f6glich, da die Biliothek zu gro\u00df ist.",
    "Cannot archive, since the library snapshot has already been archived.": "Archivierung nicht m\u00f6glich, da der Snapshot bereits archiviert wurde.",
    "Cannot archive, since the maximum number of archives for this library has been reached. Please contact Keeper support.": "Archivierung nicht m\u00f6glich, da die maximal Anzahl der Archive f\u00fcr diese Bibliothek bereits erstellt wurde. Bitte kontaktieren Sie den Keeper Support.",
    "Certify": "Zertifizieren",
    "Certify all files within the library via the bloxberg blockchain. A new entry under \u201cLibrary Details\u201d on the left sidebar will be created, where you can access the certified version and the file and a proof of certification. Certifying may take some time, depending on the size of the library. Adding metadata is optional, but recommended.": "Zertifizieren Sie alle Dateien innerhalb der Bibliothek \u00fcber die bloxberg-Blockchain. Es wird ein neuer Eintrag unter \u201cBibliotheksdetails\u201d in der linken Seitenleiste erstellt, wo Sie die zertifizierte Version und die Datei, sowie einen Nachweis der Zertifizierung einsehen k\u00f6nnen. Die Zertifizierung kann einige Zeit in Anspruch nehmen, je nach Gr\u00f6\u00dfe der Bibliothek. Das Hinzuf\u00fcgen von Metadaten ist optional, wird aber empfohlen.",
    "Certify the file through bloxberg...": "Zertifizieren Sie die Datei durch bloxberg...",
    "Certify your file via the bloxberg blockchain.": "Zertifizieren Sie Ihre Datei \u00fcber die bloxberg-Blockchain.",
    "Certify {library_name}": "{library_name} zertifizieren",
    "Certifying the library through bloxberg": "Zertifizieren der Bibliothek durch bloxberg",
    "Change": "\u00c4ndern",
    ...
    "Devices": "Ger\u00e4te",
    "Digital Object Identifier(DOI)": "Digitaler Objekt-Identifikator (DOI)",
    ...
    "Director": "Direktor",
    "Director or PI": "Direktor oder PI",
    "Directory": "Ordner",
    ...
    "Edit Metadata for {library_name} library": "Metadaten editieren f\u00fcr die Bibliothek {library_name}",
    ...
    "Handled": "Erledigt",
    "Help": "Hilfe",
    "Help / Knowledge Base": "Hilfe / Wissensdatenbank",
    "Hide": "Verbergen",
    "History": "Versionen",
    ...
    "Invite People": "Benutzer einladen",
    ...
    "Library": "Bibliothek",
    "Library Details": "Bibliotheksdetails",
    ...
    "Link to Archive": "Link zum Archiv",
    "Link to certificate": "Link zum Zertifikat",
    "Link to certificates": "Link zu den Zertifikaten",
    "Link:": "Link:",
    ...
    "Please enter the authors and affiliation of your research project.": "Bitte geben Sie die Autoren und die Zugeh\u00f6rigkeit Ihres Forschungsprojekts an.",
    "Please enter the description of your research project": "Bitte geben Sie eine Beschreibung Ihres Forschungsprojekts ein",
    "Please enter the license": "Bitte geben Sie die Lizenz ein",
    "Please enter the name of entity that holds, archives, publishes prints, distributes, releases, issues, or produces the resource": "Bitte geben Sie den Namen der Einrichtung an, die die Daten besitzt, archiviert, ver\u00f6ffentlicht, druckt, verteilt, freigibt, herausgibt oder produziert",
    ...
    "Please enter the related Max Planck Institute for this research project.": "Bitte geben Sie das zugeh\u00f6rige Max-Planck-Institut f\u00fcr dieses Forschungsprojekt ein.",
    "Please enter the resource type of the entity. Allowed values for this field: Library (default), Project.": "Bitte geben Sie den Ressourcentyp ein. Erlaubte Werte f\u00fcr dieses Feld: Bibliothek (Standard), Projekt.",
    "Please enter the title of your research project.": "Bitte geben Sie den Titel Ihres Forschungsprojekts ein.",
    "Please enter year of project start.": "Bitte geben Sie das Jahr des Projektbeginns ein.",
    "Please input at least an email.": "Bitte geben Sie mindestens eine E-Mail-Adresse an.",
    "Please note: a DOI identifier will be assigned to the current state of the selected library (snapshot). The DOI will persistently reference to the snapshot and not the latest state of the library. A DOI can only be created once per library.": "Bitte beachten: Ein digitaler Objektbezeichner (Digital Object Identifier: DOI) wird der aktuellen Version der ausgew\u00e4hlten Bibliothek zugeordnet (Schnappschuss). Eine DOI verweist auf den unver\u00e4nderbaren Schnappschuss und nicht auf den aktuellsten Zustand der Bibliothek. Zudem kann eine DOI nur einmal pro Bibliothek zugewiesen werden.",
    ...
    "Project": "Projekt",
    "Project Catalog": "Projektkatalog",
    "Public": "\u00d6ffentlich",
    ...
    "Select Author(s)": "Autor(en) ausw\u00e4hlen",
    "Select Director(s)": "Direktor(en) ausw\u00e4hlen",
    "Select File": "Datei ausw\u00e4hlen",
    "Select Image": "Bild ausw\u00e4hlen",
    "Select Institute(s)": "Institut(e) ausw\u00e4hlen",
    "Select Tags": "Tags ausw\u00e4hlen",
    "Select Year(s)": "Jahr(e) ausw\u00e4hlen",
    ...
    "Show Projects": "Projekte Filtern",
    ...
    "The KEEPER Project Catalog of the Max Planck Society": "Der KEEPER Projektkatalog f\u00fcr die Max Planck Gesellschaft",
    ...
    "This notice verifies that {detail.author_name} certified the file": "Dieser Hinweis verifiziert, dass {detail.author_name} die Datei",
    "This notice verifies that {detail.author_name} certified the files within the library {detail.repo_name} via the bloxberg blockchain. Additional information like the files and the corresponding certificates can be found at": "Dieser Hinweis verifiziert, dass {detail.author_name} die Dateien innerhalb der Bibliothek {detail.repo_name} \u00fcber die bloxberg-Blockchain zertifiziert hat. Zus\u00e4tzliche Informationen wie die Dateien und die dazugeh\u00f6rigen Zertifikate finden Sie unter",
    ...
    "Title": "Titel",
    "Title of your research project": "Titel Ihres Forschungsprojekts",
    "Token": "Token",
    "Token:": "Token:",
    "Tools": "Werkzeuge",
    ...
    "Transaction succeeded": "Transaktion erfolgreich",
    "Transfer": "\u00dcbertragen",
    ...
    "Year": "Jahr",
    "Year of project start...": "Jahr des Projektbeginns...",
    ...
    "Your files with the library {repoName} are currently being certified. We will inform you once the task has successfully finished. This may take a while.": "Ihre Dateien in der Bibliothek {repoName} werden gerade zertifiziert. Wir werden Sie informieren, sobald die Aufgabe erfolgreich abgeschlossen ist. Dies kann eine Weile dauern.",
    ...
    "bloxberg Transactions": "bloxberg-Transaktionen",
    "days": "Tage",
    "deleted": "gel\u00f6scht",
    "details": "Details",
    "draft": "Entwurf",
    ...
    "within the library {detail.repo_name} via the bloxberg blockchain. Additional information like the file and the corresponding certificate can be found at": "innerhalb der Bibliothek {detail.repo_name} \u00fcber die bloxberg-Blockchain zertifiziert hat. Zus\u00e4tzliche Informationen wie die Datei und das entsprechende Zertifikat finden Sie unter",
