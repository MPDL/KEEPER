...
urlpatterns = [
    ...
    re_path(r'^project-catalog/$', CatalogReactView.as_view(), name='project_catalog'),

    # Bloxberg
    re_path(r'^can-certify/$', CanCertify.as_view(), name='can_certify'),
    re_path(r'^certify/$', BloxbergView.as_view()),
    re_path(r'^bloxberg-pdf/(?P<transaction_id>[-0-9a-z]{66})/(?P<checksum>[-0-9a-z]{64})/$', BloxbergPdfView.as_view(), name="bloxberg-pdf"),
    re_path(r'^bloxberg-metadata/(?P<transaction_id>[-0-9a-z]{66})/(?P<checksum>[-0-9a-z]{64})/$', BloxbergMetadataJsonView.as_view(), name="bloxberg-metadata"),
    ...
    # Archive Metadata
    re_path(r'^archive-metadata/$', ArchiveMetadata.as_view(), name='archive_metadata'),
