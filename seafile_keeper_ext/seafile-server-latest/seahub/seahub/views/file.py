...
from seahub.signals import file_modified
...
def file_edit_submit(request, repo_id):
	...
	file_modified.send(sender=None, repo=repo, parent_dir=parent_dir, filename=filename, username=username, head_id=head_id)
        remove_tmp_file()
